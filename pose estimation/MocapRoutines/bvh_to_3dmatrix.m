% usage: A = bvh_to_3dmatrix('xyz.bvh',verbose);
...
% I COPIED THIS FILE FROM mocap/bvh_to_2dmatrix AND MODIFIED IT TO RETURN
% THE 3D COORDINATES INSTEAD OF THE 2D PROJECTIONS. NO OTHER CHANGE EXCEPT
% I CHANGED SCALE from 1/103 to 1

function M = bvh_to_3dmatrix(fname,debug_mode)
